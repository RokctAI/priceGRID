# Carling Black Label Beer Can 500ml

## Price
- **Current Price**: R21.99 (WITH CARD)

## Description
Enjoy a serving of this pale golden beer featuring a rich aroma and a full-flavour profile. It offers a crisp, refreshing taste with plenty of carbonation and a smooth finish that lingers. Ideal for casual settings or as a refreshing reward, this beer enhances relaxation and social gatherings with its satisfying and well-rounded flavour.
...
## Specifications
- **Product Brand**: Carling
- **Product Width (mm)**: 66
- **Product Height (mm)**: 169
- **Product Length (mm)**: 66
- **Product Gross Weight (g)**: 519
- **Product Volume**: 500ml
- **What's in the box**: 1 x 500ml Carling Black Label Beer Can
- **Unit of Measure**: EA
- **Main Barcode**: 6003326012041
- **Beer Product Type**: Lager
- **Pack Size**: Single
- **Alcohol Volume Percentage**: 5.5%
